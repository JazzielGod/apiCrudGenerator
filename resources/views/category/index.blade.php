                ...
                <div class="w-full">
                    <div class="sm:flex sm:items-center justify-between">
                        ...
                        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                            <a type="button" href="{{ route('categories.create') }}" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-black shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add new</a>
                        </div>
                    </div>
                        ...
                        <div class="mt-8 overflow-x-auto">
                            <div class="inline-block min-w-full py-2 align-middle">
                                <table class="w-full divide-y divide-gray-300">
									...
									<th scope="col" class="py-3 pl-4 pr-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500">Door</th>
                                    ...
                                    @foreach ($categories as $category)
										...
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $category->door }}</td>
										<td class="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{{ $category->product_id }}</td>
